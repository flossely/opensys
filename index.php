...
<input type="button" class="actionButton" value="U" title="Update" onclick="get('i', 'from', 'opensys', 'flossely');">
<input type="button" class="actionButton" value="X" title="Exit" onclick="get('r', 'opensys' ,'hsis', 'flossely');">
</p>
</div>
<div class='panel'>
<?php
